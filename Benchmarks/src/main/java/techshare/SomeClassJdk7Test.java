...
public class SomeClassJdk7Test {
	private static final int NO_ELEMENTS = 100_000;
	//object to be tested
	private SomeClassJdk7 testClass;
	...
	public void testArrayList() {
		...
		testClass.itDoesSomething(arrayList);
	...
	public void testLinkedList() {
		Stopwatch st = Stopwatch.createStarted();
		testClass.itDoesSomething(linkedList);
